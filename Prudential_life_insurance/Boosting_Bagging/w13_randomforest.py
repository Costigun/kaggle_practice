# -*- coding: utf-8 -*-
"""w13_RandomForest.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ll1__UdIO6aTyK2X3ZHbGWyQrL0RY2jZ
...
tree_grid = GridSearchCV(model,tree_params,cv=5,n_jobs=2,verbose=True,scoring=make_scorer(cohen_kappa_score))
tree_grid.fit(x,y)

print(tree_grid.best_params_)

model = RandomForestClassifier(max_features=tree_grid.best_params_['max_features'],
                               min_samples_leaf=tree_grid.best_params_['min_samples_leaf'],
                               n_estimators=tree_grid.best_params_['n_estimators'],
                               max_depth=tree_grid.best_params_['max_depth'],random_state=17)
model.fit(x,y)
